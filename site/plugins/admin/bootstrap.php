...
if (isset($uri) && isset($uri[0]) && $uri[0] == 'admin') {
    ...
    $flextype->registry->set('admin_navigation.help.docs', ['title' => '<i class="far fa-question-circle"></i>' . __('admin_menu_help_documentation'), 'link' => 'http://flextype.org/documentation', 'attributes' => ['class' => 'nav-link', 'target' => '_blank']]);
